...
<head>
  <meta charset="UTF-8">
  <title>📜 Logs del Sistema - IT Dev | INCARGO365</title>
...
<div class="content">
  <div class="card">
    <h2>📋 Historial de eventos y errores</h2>
      ...
      <table>
        ...
        <tbody>
          <?php foreach ($logs as $log): ?>
            <tr>
              <td><?= $log['log_id'] ?></td>
              <td class="log-<?= strtolower($log['log_type']) ?>"><?= htmlspecialchars($log['log_type']) ?></td>
    ...
    <?php else: ?>
      <p>No hay registros de log en el sistema.</p>
    <?php endif; ?>
  </div>
</div>
