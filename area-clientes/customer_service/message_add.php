<?php
// area-clientes/customer_service/message_add.php
session_start();
require_once '../db.php';

// 1) Sólo Atención al Cliente (role_id = 6) y roles con permiso de añadir mensajes
...
<head>
  <meta charset="UTF-8">
  <title>➕ Añadir Mensaje – Tiquet #<?= $ticketID ?> | Atención al Cliente</title>
...
<div class="content">
  <div class="form-container">
    <h2>➕ Añadir Mensaje – Tiquet #<?= $ticketID ?></h2>
    <?php if ($error): ?>
