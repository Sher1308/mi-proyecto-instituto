...
// 1) Sólo Finanzas (role_id = 2) y roles con permiso de actualizar tickets
...
<head>
  <meta charset="UTF-8">
  <title>Editar Ticket #<?= $id ?> – Finanzas | INCARGO365</title>
  ...
  <style>
    ...
    select, textarea { width:100%; padding:10px; margin-bottom:20px; border:1px solid #ccc; border-radius:6px; font-family:'Segoe UI'; }
...
<header>
  <h1>✏️ Editar Ticket #<?= $id ?> – Finanzas</h1>
...
// Dispara al cargar para setear visibilidad inicial
