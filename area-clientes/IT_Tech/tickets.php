...
// 2) Carga tickets ordenados según empresa (vw_tickets_empresas)
...
<head>
  <meta charset="UTF-8">
  <title>Tickets – Panel Técnico | INCARGO365</title>
  ...
  <style>
    ...
    .card h2 { font-size:20px; margin-top:0; margin-bottom:15px; }
    .new-ticket-btn {
      display:inline-block; margin-bottom:15px; padding:8px 12px;
      background:#0d3b66; color:white; border-radius:6px; text-decoration:none;
    }
...
<div class="content">
  <div class="card">
    ...
    <?php if ($canCreate): ?>
      <a href="ticket_add.php" class="new-ticket-btn">➕ Nuevo Ticket</a>
    <?php endif; ?>
