...
<div class="content">
  <div class="card">
    ...
    <ul>
      ...
      <li>🛡️ Base de datos: <strong>✅ Conexión activa</strong></li>
      <li>🖥️ Dirección IP del servidor: <strong><?= $_SERVER['SERVER_ADDR']; ?></strong></li>
      <li>⏰ Fecha actual: <strong><?= date("Y-m-d H:i:s"); ?></strong></li>
    </ul>
  </div>
  ...
  <div class="card">
    ...
    <ul>
      <li>📜 <a href="logs.php">Ver registros técnicos</a></li>
      <li>🔌 <a href="integrations.php">Ver integraciones activas</a></li>
      <li>📦 <a href="packages.php">Consultar paquetes</a></li>
    </ul>
  </div>
</div>
