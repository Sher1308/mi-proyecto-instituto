<?php
// area-clientes/it_tech/ticket_edit.php
session_start();
require_once '../db.php';

// 1) Sólo IT_Tech (role_id = 5) y roles con permiso de actualizar tickets
...
<head>
  <meta charset="UTF-8">
  <title>✏️ Editar Ticket #<?= $id ?> – Panel Técnico | INCARGO365</title>
